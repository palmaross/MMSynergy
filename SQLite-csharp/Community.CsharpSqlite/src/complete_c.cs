...
*/
	...
	{
		int c = (int)C;
		return (c < 256 && (sqlite3CtypeMap[c] & 0x46) != 0);
	}
#endif
//#if  SQLITE_EBCDIC
...
*/
	...
	static public int sqlite3_complete( string zSql1 )
	{
...
*/
  ...
  */
	 ...
	 /* 2  NORMAL: */new u8[] {	1,  2,	 2, },
	  ...
	  int zIdx = 0;
	  char[] zSql = zSql1.ToCharArray();
	  System.Array.Resize(ref zSql, zSql.Length + 1);
	  zSql[zSql.Length - 1] = '\0';
...
//#endif
			  if ( IdChar( zSql[zIdx] ) )
			  {
				...
				switch ( zSql[zIdx] )
				{
				  ...
				  case 'C':
					{
					  if ( nId == 6 && sqlite3StrNICmp( zSql1, zIdx, "create", 6 ) == 0 )
					  {
						token = tkCREATE;
					  }
					  else
				  ...
				  case 'T':
					{
					  if ( nId == 7 && sqlite3StrNICmp( zSql1, zIdx, "trigger", 7 ) == 0 )
					  {
						token = tkTRIGGER;
					  }
					  else if ( nId == 4 && sqlite3StrNICmp( zSql1, zIdx, "temp", 4 ) == 0 )
					  {
						token = tkTEMP;
					  }
					  else if ( nId == 9 && sqlite3StrNICmp( zSql1, zIdx, "temporary", 9 ) == 0 )
					  {
						token = tkTEMP;
					  }
					  else
				  ...
				  case 'E':
					{
					  if ( nId == 3 && sqlite3StrNICmp( zSql1, zIdx, "end", 3 ) == 0 )
					  {
						token = tkEND;
					  }
					  else
#if !SQLITE_OMIT_EXPLAIN
						if ( nId == 7 && sqlite3StrNICmp( zSql1, zIdx, "explain", 7 ) == 0 )
						{
						  token = tkEXPLAIN;
						}
						else
