...
namespace IniParser
{
	...
	public class FileIniDataParser : StreamIniDataParser
	{
		...
		{
			return LoadFile(fileName, relaxedIniRead, new System.Text.UTF8Encoding());
		}
		...
		///	 File's encoding.
		/// </param>
		public IniData LoadFile(string fileName, bool relaxedIniRead, System.Text.Encoding fileEncoding)
		{
